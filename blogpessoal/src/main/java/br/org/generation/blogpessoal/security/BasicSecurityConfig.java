...
public class BasicSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean //Criptografa a senha e checa se ela está certa
    public PasswordEncoder passwordEncoder() {
        return new  BCryptPasswordEncoder ();
    }

    @Override
    protected void configure(HttpSecurity http) throws Exception{ //Configura as regras de acesso// Autorização
